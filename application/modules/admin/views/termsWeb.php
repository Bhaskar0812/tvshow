...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
                ...
                <div class="body col-md-12">
                    ...
                    <form class="form-horizontal" role="form" id="editTcUsWeb" method="post" action="<?php echo base_url('admin/editTcUsWeb') ?>" enctype="multipart/form-data">
